"""
This module is from Django 1.6 and can be removed when this Django installation
is upgraded. However, there is one class at the bottom of this file that must
remain: NestedCheckboxRender
"""
